...
// replace go.opentelemetry.io/contrib/instrumentation/google.golang.org/grpc/otelgrpc => ./internal/otelgrpc
// replace go.opentelemetry.io/otel v1.16.0 => ./internal/otel
// replace go.opentelemetry.io/otel/trace v1.16.0 => ./internal/trace
